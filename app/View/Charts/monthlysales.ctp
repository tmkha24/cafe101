...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1><?php echo __('Monthly sales');?></h1>
			</div>
			<div class="col-sm-6">
...
<script>
	var options = {
		...
		title: {
          text: '2020 monthly sales',
          align: 'center'
        },
		series: [
            {
                name: 'Product 1',
                data: [30,40,35,50,49,60,70,91,125,99,130,141]
            },
            {
                name: 'Product 2',
                data: [15,45,27,36,66,30,58,72,112,97,88,103]
            },
            {
                name: 'Product 3',
                data: [11,58,42,55,59,81,97,118,150,162,144,156]
            }
        ],
		xaxis: {
