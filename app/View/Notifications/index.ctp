				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title"><?php echo __('Notification List')?></h3>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-6">
							...
							<table id="table1" class="table table-bordered table-striped">
								...
								foreach ($notifications as $notification): ?>
									<tr>
										...
										<td><?php echo $this->Html->link($this->App->truncate(h($notification['Notification']['title']),100), array('action' => 'view', $notification['Notification']['id'])); ?></td>
										<td><?php echo $this->App->truncate(h($notification['Notification']['content']),100); ?></td>
										<td><?php echo $this->Time->nice(h($notification['Notification']['created'])); ?></td>
