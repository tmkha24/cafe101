			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active"><?php echo __('Add Order');?></li>
					</ol>
				</div>
			</div>
		</div>
						...
						<div class="card-body">
							<fieldset>
								...
								<div class="form-check">
									...
									<input  type="checkbox" name="data[Order][same_as_billing_address]" class="form-check-input" id="Ordersame_as_billing_address">
								 ...
								 <div class="table-responsive">
									 <table class="table">
										 <tbody><tr>
											 ...
											 <td><input value="0" readonly="true" name="data[Order][amount]" class="form-control" step="1" type="number" id="subtotal"></td>
										 </tr>
										 <tr>
											 <th><?php echo __('Discount Amount:');?></th>
											 <td style="vertical-align: inherit"><span style="font-weight: bold;" class="symbol-currency"></span></td>
											 <td><input name="data[Order][discount_amount]" data-type="currency" value="0" class="form-control" step="1" type="number" id="orderdiscount"></td>
										 </tr>
										 <tr>
											 <th><?php echo __('Shipping Cost:');?></th>
											 <td style="vertical-align: inherit"><span style="font-weight: bold;" class="symbol-currency"></span></td>
											 <td><input name="data[Order][shipping_cost]" value="0" class="form-control" step="1" type="number" id="ordershippingcost"></td>
										 </tr>
										 <tr>
											 <th><?php echo __('Total:');?></th>
											 <td style="vertical-align: inherit"><span style="font-weight: bold;" class="symbol-currency"></span></td>
											 <td><input value="0" readonly="true" name="data[Order][grant_total]" class="form-control" step="1" type="number" id="total"></td>
										 </tr>
										 </tbody></table>
								 </div>
						 </div>
