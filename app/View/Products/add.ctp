...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1><?php echo __d('product', 'Thêm sản phẩm'); ?></h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo Router::url('/products', true) ?>"><?php echo __('Trở lại') ?></a></li>
					<li class="breadcrumb-item active"><?php echo __('Thêm sản phẩm'); ?></li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<?php echo $this->Form->submit(__('Đăng sản phẩm'), array("class" => "btn btn-primary float-right")); ?>
			</div>
		</div>
		<br>
	</div>
