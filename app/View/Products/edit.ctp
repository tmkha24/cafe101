...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1><?php echo __d('product','Edit Product');?></h1>
			</div>
			<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<div class="input-group-prepend ">
																<span
																	class="input-group-text imageBannerPreview"
																	id="imageBannerPreview<?php echo $i;?>" style="padding:0px; width: 38px; height: 38px;">
																	<?php if(!empty($requestData['image'.$i])){
																		echo $this->Html->image('/img/product/'.$requestData['image'.$i],
									...
									<div class="form-check">
										<input type="checkbox"
											   name="data[Product][<?php echo  'image'.$i.'_delete'?>]"
											   class="form-check-input"
											   id="<?php echo 'image'.$i.'_delete' ?>">
										<label class="form-check-label"
											   for="<?php echo 'image'.$i.'_delete' ?>">
											<?php echo __('Delete')?>
										</label>
									</div>
								</div>
						...
						<fieldset>
							...
							<div class="form-group">
								...
								echo $this->Form->input('currency', array(
									'options' => array(
										'HK$' => 'HK$'),
									'default'=>$product['Product']['currency'],
									'class'=>'form-control',
									"label"=>__("Currency")
								));
								?>
							...
							<div class="form-check">
								...
								<input  <?php if($checked){echo "checked";} ?>  type="checkbox" name="data[Product][active]" class="form-check-input" id="ProductActive">
