			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<div class="col-12">
							<h1><?php echo __('Customer All Invoices Journal');?></h1>
						</div>
					...
					<div class="card-body">
						<table id="table1" class="table table-binvoiceed table-striped">
							...
							foreach ($invoices as $invoice): $i++;?>
								<tr>
									<td><?php echo $i; ?></td>
									<td><?php echo $this->Html->link(h($invoice['Invoice']['number']), array('controller'=>'invoices','action' => 'viewinvoice', $invoice['Invoice']['id'])); ?></td>
						...
						<div class="row">
							<div class=" col-6 mt-5">
								<p class="lead">Total Summary (Paid)</p>
							...
							<div class=" col-6 mt-5">
								<p class="lead">Total Summary (Unpaid)</p>

								<div class="table-responsive">
									<table class="table">
										<tbody><tr>
											<th style="width:50%"><?php echo "Subtotal:" ?></th>
											<td><?php echo $invoicesTotalUnPaid['0']['0']['amount'] ?></td>
										</tr>
										<tr>
											<th><?php echo "Discount Amount:" ?></th>
											<td><?php echo $invoicesTotalUnPaid['0']['0']['discount_amount'] ?></td>
										</tr>
										<tr>
											<th><?php echo "Shipping Cost:" ?></th>
											<td><?php echo $invoicesTotalUnPaid['0']['0']['shipping_cost'] ?></td>
										</tr>
										<tr>
											<th><?php echo "Total:" ?></th>
											<td><?php echo $invoicesTotalUnPaid['0']['0']['grant_total'] ?></td>
										</tr>
										</tbody></table>
								</div>
							</div>
