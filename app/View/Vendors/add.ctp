	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1><?php echo __d('vendor','Add Vendor');?></h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="<?php echo Router::url('/', true)?>"><?php echo __('Home') ?></a></li>
						<li class="breadcrumb-item active"><?php echo __('Add Vendor');?></li>
					</ol>
				</div>
			</div>
		</div>
							...
							<div class="card-body">
								...
								<fieldset>
									...
									<div class="form-check">
										...
										<input type="checkbox" name="data[Vendor][active]" class="form-check-input" id="VendorActive">
										<label class="form-check-label" for="VendorActive"><?php echo __('Active')?></label>
									</div>
